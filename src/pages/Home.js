...
export default function Home() {
    return (
        <Container className="about-container">
            <Row className="index-row-2 bg-color center-align mt2">
                ...
                <Col s={12} m={6} l={4} className="bg-color">
                    <h5>Hello! </h5>
                    <p>My name is Sam.</p>
                    ...
                    <p>Spent the last decade developing a variety of Project Management and hands on trade skills and .</p>
                    <p>Born and raised in the Pacific Northwest.</p>
                    <p>Traveled to 9 different countries so far.</p>
                </Col>
